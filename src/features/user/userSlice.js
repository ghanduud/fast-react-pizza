...
export const fetchAddresss = createAsyncThunk('user/fetchAddress', async function () {
	...
	extraReducers: (builder) =>
		builder
			...
			.addCase(fetchAddresss.rejected, (state) => {
				state.status = 'error';
				state.error = 'There was a problem getting the address make sure to fill that field';
			}),
});
